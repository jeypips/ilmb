...
<html>
    ...
    <body class="fixed-left" ng-app="services" ng-controller="servicesCtrl" account-profile>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li><a href="attendance.php"><i class="icon-check"></i><span> Attendance </span></a></li>
							...
							<li ng-show="accountProfile.account_type == 'Admin'"><a href="services.php" class="active"><i class="icon-wrench"></i><span> Services </span></a></li>
