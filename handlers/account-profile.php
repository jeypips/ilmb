...
$sql = "SELECT account_id, CONCAT(account_firstname, ' ', account_lastname) fullname, account_username, account_type FROM account_infos WHERE account_id = $_SESSION[account_id]";
