...
$personal_infos = $con->getData("SELECT personal_infos.id, events.description, personal_infos.address_barangay, personal_infos.address_municipality,personal_infos.firstname, personal_infos.middlename, personal_infos.lastname FROM personal_infos, events WHERE personal_infos.id = events.id"); //Get data from another Table
 // Convert id to array
